...
class UpdateClockA extends StatefulWidget {
  final Function(String) onUpdate;

  const UpdateClockA({required this.onUpdate, super.key});

  @override
  _UpdateClockState createState() => _UpdateClockState();
}

class _UpdateClockState extends State<UpdateClockA> {
  ...
  void _updateClock() {
    if (_periods.isNotEmpty) {
      ...
      StringBuffer messageBuilder = StringBuffer('#SA$periodsCount');
